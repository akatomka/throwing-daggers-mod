...
public enum DartMaterial {
    ...
    COPPER(ToolMaterial.COPPER, "copper", 4.0f, 1.45f,
            DartsMod.id("textures/entity/projectiles/dartprojectilecopper.png")),
    ...
    public Identifier projectileTexture() {
